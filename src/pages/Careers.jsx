...
export default function Careers() {
  ...
  // Content (kept exactly from your existing Careers page)
  const whyVedansh = [
    {
      icon: <FaRocket />,
  ...
  const hiringProcess = [
    ...
    },
    {
      step: '2',
      title: 'Screening',
      desc: 'HR reviews your profile within 3-5 days',
    },
    {
      step: '3',
      title: 'Technical Round',
      desc: 'Interview with department head',
    },
    {
      step: '4',
      title: 'Final Interview',
      desc: 'Discussion with senior management',
    },
    {
      step: '5',
      title: 'Offer',
      desc: 'Receive offer and join Vedansh!',
    },
  ];
  ...
  // Page animations (staggered cards + section headers)
  useEffect(() => {
    const ctx = gsap.context(() => {
      // Hero fade (subtitle + buttons)
      ...
      const animateSection = (sectionEl, cardSelector = '.reveal-card') => {
        ...
        // IMPORTANT:
        // About/Services work with ScrollTrigger, but if smooth scrolling or refresh timing
        // ever prevents triggers from firing, `gsap.from(...)` can leave elements hidden.
        // We keep everything VISIBLE by default and set `immediateRender:false` so
        // the animation only applies when the trigger actually runs.
      ...
      <div ref={pageRef}>
        ...
        >
          ...
          <div className="container" style={{ position: 'relative', zIndex: 1 }}>
            <div style={{ maxWidth: '980px', margin: '0 auto', textAlign: 'center' }}>
              ...
              >
                Join Vedansh Infra and work on India's most challenging industrial EPC projects across Metal, Power,
                Chemical, and Renewable sectors.
              </p>
        ...
        <section style={{ padding: '40px 0', backgroundColor: '#1F2937' }}>
          <div className="container">
            ...
            ><div>
              ...
              <div>
                <div style={{ fontSize: '46px', fontWeight: '900', color: '#1fadbf', marginBottom: '8px' }}>50+</div>
                <p style={{ color: '#E5E7EB', fontWeight: '500' }}>Major Clients</p>
              </div>
              <div>
                <div style={{ fontSize: '46px', fontWeight: '900', color: '#1fadbf', marginBottom: '8px' }}>Zero</div>
        ...
        <section ref={whyRef} style={{ padding: '120px 0', backgroundColor: '#FFFFFF' }}>
          <div className="container">
            <div style={{ textAlign: 'center', marginBottom: '80px' }}>
              <h2 className="section-animate" style={sectionTitle}>
                Why Join Vedansh?
              </h2>
              <p className="section-animate" style={sectionSubtitle}>
                You’ll work on high-impact industrial infrastructure, learn from experienced leaders, and grow your career
            ...
            <div className="cert-grid">
              {whyVedansh.map((item, i) => (
                ...
                >
                  ...
                  <h3 style={{ fontSize: '26px', fontWeight: '800', marginBottom: '12px', fontFamily: "'Poppins', sans-serif", color: '#1F2937' }}>
                    {item.title}
                  </h3>
                  <p style={{ color: '#6B7280', lineHeight: '1.8', fontSize: '16px' }}>{item.description}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="container">
            ...
            <div className="cert-grid">
              {careerPaths.map((path, i) => (
                ...
                >
                  <h3 style={{ fontSize: '26px', fontWeight: '800', marginBottom: '10px', fontFamily: "'Poppins', sans-serif", color: '#1F2937' }}>
                    {path.title}
                  </h3>
                  <p style={{ color: '#6B7280', lineHeight: '1.8', marginBottom: '22px' }}>{path.description}</p>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                    {path.steps.map((step, idx) => (
                      ...
                      >
                        <FaCheckCircle style={{ color: '#1fadbf', flexShrink: 0 }} />
            ...
            <div className="benefits-grid">
              {benefits.map((b, i) => (
                ...
                >
                  ...
                  <h3 style={{ fontSize: '22px', fontWeight: '800', marginBottom: '10px', fontFamily: "'Poppins', sans-serif", color: '#1F2937' }}>
                    {b.title}
                  </h3>
                  <p style={{ color: '#6B7280', lineHeight: '1.8' }}>{b.description}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="openings" ref={openingsRef} style={{ padding: '120px 0', backgroundColor: '#F8F9FA' }}>
          <div className="container">
            ...
            >
              <div>
                <label style={{ display: 'block', fontWeight: 700, marginBottom: '10px', color: '#374151' }}>Department</label>
              ...
              <div>
                <label style={{ display: 'block', fontWeight: 700, marginBottom: '10px', color: '#374151' }}>Experience Level</label>
              ...
              {filteredJobs.length ? (
                filteredJobs.map((job) => (
                  ...
                  >
                    <div style={{ display: 'flex', justifyContent: 'space-between', gap: '16px', alignItems: 'flex-start', marginBottom: '14px' }}>
                      <h3 style={{ fontSize: '22px', fontWeight: 900, margin: 0, fontFamily: "'Poppins', sans-serif", color: '#1F2937' }}>
                        {job.title}
                      </h3>
                      <span style={{ fontSize: '13px', fontWeight: 800, color: '#1fadbf', background: 'rgba(31,173,191,0.12)', padding: '8px 12px', borderRadius: '999px' }}>
                        {job.type}
                      </span>
                    </div>

                    <div className="job-meta-row" style={{ marginBottom: '16px' }}>
                      <span className="job-meta-pill">
                        <FaBriefcase style={{ color: '#1fadbf' }} /> {job.department}
                      </span>
                      <span className="job-meta-pill">
                        <FaClock style={{ color: '#1fadbf' }} /> {job.experience}
                      </span>
                      <span className="job-meta-pill">
                        <FaMapMarkerAlt style={{ color: '#1fadbf' }} /> {job.location}
                      </span>
                    </div>

                    <p style={{ color: '#6B7280', lineHeight: '1.8', marginBottom: '18px' }}>{job.description}</p>

                    <div style={{ marginBottom: '22px' }}>
                      <strong style={{ color: '#374151' }}>Requirements:</strong>
                      <ul style={{ marginTop: '12px', paddingLeft: 0, listStyle: 'none', display: 'grid', gap: '10px' }}>
                        {job.requirements.map((req, idx) => (
                          <li key={idx} style={{ display: 'flex', gap: '12px', alignItems: 'flex-start', color: '#4B5563' }}>
                ...
                >
                  <p style={{ color: '#6B7280', fontSize: '16px', lineHeight: '1.8' }}>
                    No openings match your filters. Try adjusting your selection or check back soon for new opportunities.
                  </p>
                </div>
              )}
            </div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: '18px' }}>
                    <div
                      style={{
                        ...
                        height: '54px',
                        borderRadius: '18px',
                        background: 'rgba(31,173,191,0.12)',
                        display: 'flex',
                        alignItems: 'center',
                    ...
                    <div>
                      <div style={{ fontWeight: 900, color: '#1F2937', fontFamily: "'Poppins', sans-serif" }}>{t.name}</div>
                      <div style={{ color: '#6B7280', fontSize: '14px' }}>{t.position}</div>
                      <div style={{ color: '#9CA3AF', fontSize: '13px', marginTop: '2px' }}>{t.experience}</div>
                    </div>
                  </div>

                  <p style={{ color: '#4B5563', lineHeight: '1.9', fontSize: '16px' }}>"{t.quote}"</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section ref={applyRef} style={{ padding: '120px 0', backgroundColor: '#FFFFFF' }}>
          <div className="container">
            <div style={{ textAlign: 'center', marginBottom: '70px' }}>
              ...
              <p className="section-animate" style={sectionSubtitle}>
                Start your journey with Vedansh Infra today.
              </p>
            </div>
            ...
            >
              <form onSubmit={handleSubmit}>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '18px' }}>
                  <div>
                    <label style={{ display: 'block', fontWeight: 700, marginBottom: '10px', color: '#374151' }}>Full Name *</label>
                    <input className="careers-input" type="text" name="name" value={formData.name} onChange={handleInputChange} required />
                  </div>

                  <div>
                    <label style={{ display: 'block', fontWeight: 700, marginBottom: '10px', color: '#374151' }}>Email *</label>
                    <input className="careers-input" type="email" name="email" value={formData.email} onChange={handleInputChange} required />
                  </div>

                  <div>
                    <label style={{ display: 'block', fontWeight: 700, marginBottom: '10px', color: '#374151' }}>Phone *</label>
                    <input className="careers-input" type="tel" name="phone" value={formData.phone} onChange={handleInputChange} required />
                  </div>

                  <div>
                    <label style={{ display: 'block', fontWeight: 700, marginBottom: '10px', color: '#374151' }}>Position Applied For *</label>
                  ...
                  <div>
                    <label style={{ display: 'block', fontWeight: 700, marginBottom: '10px', color: '#374151' }}>Total Experience *</label>
                  ...
                  <div>
                    <label style={{ display: 'block', fontWeight: 700, marginBottom: '10px', color: '#374151' }}>Current Location *</label>
                  ...
                  <div style={{ gridColumn: '1 / -1' }}>
                    <label style={{ display: 'block', fontWeight: 700, marginBottom: '10px', color: '#374151' }}>Resume (PDF/DOC) *</label>
                    ...
                    <p style={{ marginTop: '10px', color: '#6B7280', fontSize: '13px' }}>
                      Please upload your latest resume. (In this demo version, it is not uploaded to a server.)
                    </p>
                  </div>

                  <div style={{ gridColumn: '1 / -1' }}>
                    <label style={{ display: 'block', fontWeight: 700, marginBottom: '10px', color: '#374151' }}>Cover Letter / Message</label>
                ...
                <div style={{ display: 'flex', justifyContent: 'center', marginTop: '26px' }}>
                  <button type="submit" className="btn btn-primary" style={{ paddingLeft: '44px', paddingRight: '44px' }}>
                    Submit Application
                  </button>
                </div>

                <div style={{ marginTop: '22px', textAlign: 'center', color: '#6B7280', fontSize: '14px' }}>
                  <span style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', marginRight: '14px' }}>
